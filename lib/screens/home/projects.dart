      ...
      child: Center(
        child: Container(
          decoration: BoxDecoration(
            color: Colors.white,
            borderRadius: BorderRadius.circular(Layout.getHeight(context, 30)),
            boxShadow: [
              BoxShadow(
          ...
          margin: EdgeInsets.symmetric(vertical: Layout.getHeight(context, 30)),
          child: Row(
            ...
            children: [
              Padding(
                padding: EdgeInsets.only(right: Layout.getWidth(context, 8)),
                child: Image.asset(
