...
import 'package:deroli_mobile/components/retire/custom_bottom_navbar.dart';
...
class _FullRequestDetailsScreenState extends State<FullRequestDetailsScreen> {
  ...
  Color _getStatusColor() {
    return widget.payment.status.toLowerCase() == 'pending'
        ...
        ? Color(0xFF4CAF50)
        : widget.payment.status.toLowerCase() == 'completed'
        ? Color(0xFF4CAF50)
        : widget.payment.status.toLowerCase() == 'success'
        ? Color(0xFF4CAF50)
        : widget.payment.status.toLowerCase() == 'initiated'
        ? Color(0xFFE3B644)
        : Color(0xFFE3B644);
  }
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: Padding(
                                          padding: EdgeInsets.symmetric(
                                            horizontal: Layout.getWidth(
                                              context,
                                              14,
                                            ),
                                            vertical: Layout.getHeight(
                                              context,
                                              2,
                                            ),
                                          ),
            ...
            child: Align(
              ...
              child: LiquidGlassLayer(
                ...
                child: LiquidGlass(
                  ...
                  child: CustomBottomNavBar(payment: widget.payment),
                ),
              ),
            ),
          ),
